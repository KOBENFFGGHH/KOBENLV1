...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("KOBEN Hub|BFมือถือVIP",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    ...
    Main:AddToggle("เซฟออโต้",true,function(value)
    ...
    Main:AddToggle("รวม มอน",true,function(value)
        _G.BringMonster = value
    end)

    Main:AddToggle("ตีเร็ว [1]",true,function(value)
...
Main:AddToggle("ตีเร็ว [2]",true,function(value)
...
spawn(function()
    ...
    local AutoFarm = Main:AddToggle("ออโต้ฟาร์เวล[ต้องเปิดฮาคิเกราะเอง]",_G.AutoFarm,function(value)
        _G.AutoFarm = value
    ...
    Main:AddToggle("ทำหมัดซุป",_G.AutoSuperhuman,function(value)
    ...
    Main:AddToggle("ทำขาดำV2",_G.AutoDeathStep,function(value)
